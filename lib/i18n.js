...
const dict = {
  es: {
    ...
    "hero.releaseEyebrow": "Ya disponible en Spotify · 2026",
    "hero.releaseBadge": "Ya disponible",
    "hero.releaseSub": "(2026 Remaster) — Ya en Spotify",
    "hero.releaseDate": "Ya disponible en Spotify",
    "hero.released": "Ya disponible en Spotify",
    "hero.previewLabel": "Escucha el single completo en Spotify",
    "hero.releaseDesc":
      "Nació en 2020, en el confinamiento de la pandemia en Ecuador. Es una canción sobre el amor y la ausencia. Seis años después, la versión definitiva ya está disponible en Spotify con el sonido que siempre imaginamos.",
  ...
  en: {
    ...
    "hero.releaseEyebrow": "Now available on Spotify · 2026",
    "hero.releaseBadge": "Out now",
    "hero.releaseSub": "(2026 Remaster) — Now on Spotify",
    "hero.releaseDate": "Now available on Spotify",
    "hero.released": "Now available on Spotify",
    "hero.previewLabel": "Listen to the full single on Spotify",
    "hero.releaseDesc":
      "Born in 2020, during the pandemic lockdown in Ecuador. It's a song about love and absence. Six years later, the definitive version is now available on Spotify with the sound we always imagined.",
