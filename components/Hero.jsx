...
function FeaturedHero() {
  const { t } = useLang();
  return (
    <div className="hero__single hero__single--split">
      <h1 className="sr-only">En Mi Mente (2026 Remaster) — Dune Moon — Ya disponible en Spotify</h1>
      <p className="eyebrow hero__eyebrow hero__eyebrow--brand">{t("hero.mainEyebrow")}</p>
      <div className="hero__featured hero__featured--split">
        <div className="hero__featured-left">
        ...
        <div className="hero__featured-right">
          <div className="hero__spotify-embed hero__spotify-embed--hero">
            <iframe title="En Mi Mente en Spotify" src="https://open.spotify.com/embed/album/1ucrIBMI2Znsd5RiCx94rz?utm_source=generator&theme=0" width="100%" height="352" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="eager" style={{ borderRadius: 12 }} />
          </div>
