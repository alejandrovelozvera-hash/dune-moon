        ...
        <Reveal delay={1}>
          <div className="manifesto__hero">
            ...
            <div className="manifesto__hero-side">
              ...
              <div style={{ marginTop: 18, borderRadius: 12, overflow: "hidden", border: "1px solid rgba(255,255,255,0.1)" }}>
                <iframe title="En Mi Mente (2026 Remaster) en Spotify" src="https://open.spotify.com/embed/album/1ucrIBMI2Znsd5RiCx94rz?utm_source=generator&theme=0" width="100%" height="152" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy" style={{ borderRadius: 12 }} />
              </div>
            </div>
          </div>
        </Reveal>
